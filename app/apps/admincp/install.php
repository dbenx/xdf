            ...
            <div class="form-actions">
                <?php if (isset($_GET['git'])) { ?>
                    <a class="btn btn-success btn-large"
                       href="<?php echo APP_URI; ?>&do=install&release=<?php echo patch::$release; ?>&zipname=<?php echo $_GET['zipname']; ?>&git=true"><i
                                class="fa fa-wrench"></i> 开始升级</a>
                <?php } else { ?>
                    <a class="btn btn-success btn-large" href="<?php echo APP_URI; ?>&do=install"><i
                                class="fa fa-wrench"></i> 开始升级</a>
                <?php } ?>
            </div>
        <?php } ?>
