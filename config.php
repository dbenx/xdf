...
define('iPHP_DB_NAME','szxdficmsv7'); // 数据库名
define('iPHP_DB_PREFIX','szxdfpr_');// 表名前缀, 同一数据库安装多个请修改此处
...
//----------------------------------------
define('iPHP_KEY','yE8T28wKc55U9NcgGmT7TmQ93QTkdRPVxYeJA9SuyzjBmPujAsvgZPLufv3a47bk');
